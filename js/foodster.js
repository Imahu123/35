...
$(function () {
    ...
    $("input1,textarea1").jqBootstrapValidation({
        preventSubmit: true,
...
$(window).on('load', function () {
    ...
    $('.agAnargyroiPopUp').on('show.bs.modal', function (e) {
        // Call function for Google Maps when a modal is opened
        setTimeout(function () {
//            loadGoogleMap();
            loadAgAnargyroiGoogleMap();
        }, 300);
    });
    // Call function for Google Maps
    $('.filadelfeiaPopUp').on('show.bs.modal', function (e) {
        // Call function for Google Maps when a modal is opened
        setTimeout(function () {
//            loadGoogleMap();
            loadFiladelfeiaGoogleMap();
        }, 300);
    });
    $('.monastirakiPopUp').on('show.bs.modal', function (e) {
        // Call function for Google Maps when a modal is opened
        setTimeout(function () {
//            loadGoogleMap();
            loadMonastirakiGoogleMap();
        }, 300);
    });
    $('.marousiPopUp').on('show.bs.modal', function (e) {
        // Call function for Google Maps when a modal is opened
        setTimeout(function () {
//            loadGoogleMap();
            loadMarousiGoogleMap();
        }, 300);
    });
    $('.xolargosPopUp').on('show.bs.modal', function (e) {
        // Call function for Google Maps when a modal is opened
        setTimeout(function () {
//            loadGoogleMap();
            loadXolargosGoogleMap();
        }, 300);
    });
    $('.kypseliPopUp').on('show.bs.modal', function (e) {
        // Call function for Google Maps when a modal is opened
        setTimeout(function () {
//            loadGoogleMap();
            loadKypseliGoogleMap();
        }, 300);
    });
    $('.keratsiniPopUp').on('show.bs.modal', function (e) {
        // Call function for Google Maps when a modal is opened
        setTimeout(function () {
//            loadGoogleMap();
            loadKeratsiniGoogleMap();
        }, 300);
    });
    $('.korydallosPopUp').on('show.bs.modal', function (e) {
        // Call function for Google Maps when a modal is opened
        setTimeout(function () {
//            loadGoogleMap();
            loadKorydallosGoogleMap();
        }, 300);
    });
